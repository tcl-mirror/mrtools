 ...
 */
extern void bookstore_changeSelectionQuantity(MRT_InstId cartID, MRT_InstId productID, unsigned quantity) ;

/*
 * External Operations Declarations
 */
extern void bookstore_CreditCardCompany_requestChargeApproval__EOP(MRT_InstId cccID, char const * accountNumber, char const * billingAddress, char const * cardholderName, DateType_t cardExpirationDate, unsigned transactionID, unsigned chargeAmount) ;
extern void bookstore_OnlineCustomer_chargeDeclined__EOP(MRT_InstId customerID, char const * email) ;
extern void bookstore_OnlineCustomer_chargeApproved__EOP(MRT_InstId customerID, char const * email) ;
extern void bookstore_OnlineCustomer_orderReportedDelivered__EOP(MRT_InstId customerID, char const * email) ;
extern void bookstore_ShippingCompanyEE_shipmentReadyForPickup__EOP(MRT_InstId shipmentID) ;
extern void bookstore_ShippingClerkEE_shipmentReadyToPack__EOP(MRT_InstId clerkID, unsigned shipmentID) ;
