# created by mkmodule: version 1.5
# on Sat Aug 07 14:41:48 PDT 2021
set __loadScript__ {{offset size} {
    set schan [open [info script] r]
    try {
        chan seek $schan $offset start
        uplevel 1 [chan read $schan $size]
    } finally {
        chan close $schan
    }
}}
::apply $__loadScript__ 1216 190236
::apply $__loadScript__ 191453 487906
catch {unset __loadScript__}
catch {unset __loadBinary__}
catch {unset __loadedBinary__}
return
    ...
    namespace eval @Gen@ {
        ...
        namespace eval Helpers {
            ...
            proc GatherClassProperties {domain} {
                ...
                set classRefs [FindNonUnionSubclasses $domain] ;                    # <1>
        ...
        namespace eval GenHeader {
            ...
            proc portalIds {} {
                ...
                # puts [relformat ${::micca::@Gen@::Helpers::ClassProperties} ClassProperties]
